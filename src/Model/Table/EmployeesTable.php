 ...
 * @property \App\Model\Table\MinistersTable&\Cake\ORM\Association\HasMany $Ministers
 * @property \App\Model\Table\PitsTable&\Cake\ORM\Association\HasMany $Pits
 *
...
class EmployeesTable extends Table
{
    ...
    {
        $rules->add($rules->isUnique(['siape', 'email']), ['errorField' => 'siape']);
